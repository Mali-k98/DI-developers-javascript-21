...
// const getCarHonda= inventory.filter(c => c.car_make === 'Honda').reduce(first => console.log(`this is a ${first['car_make']} ${first['car_model']} made in ${first['car_year']}`))
...
// let sortCarInventoryByYear = inventory.sort(function (x, y){ return x.car_year - y.car_year})
